                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form name="myForm" id="form1" novalidate>
                            ...
                            <div class="form-group">
                                <label for="friend_link-pic" class="control-label">头图<em class="text-danger">（必填）</em> :</label>
                                <input type="file" class="file-loading" id="file0" name="pic">
                                <div id="errorBlock" class="help-block"></div>
                                <a ng-href="@{{picsrc}}" data-lightbox="example-set" data-title="上传的图片" ng-show="upload_image"/>
                                    <img src="@{{picsrc}}" alt="已上传的图片" width="50px" height="50px">
                                </a>
                                <input type="hidden" class="form-control" id="File" ng-model="friend_link.pic" required>
                            </div>
    ...
    <script>
        $(function () {
            ...
            $('#file0').fileinput({
                ...
                scope.friend_link.pic = data.response.res;
                scope.picsrc = '/uploads/' + data.response.res;
                        ...
                        case 'edit':
                            ...
                            $http.get('/admin/friend-link/' + id)
                                .then(function successCallback(response) {
                                    ...
                                    $scope.picsrc = '/uploads/' +  $scope.friend_link.pic;
                                    $scope.upload_image = true;
                                });
                            break;
                        default:
