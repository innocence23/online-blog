...
@section('title', '字典评论管理')

@section('content_header')
    <h1>字典评论管理</h1>
    <ol class="breadcrumb">
        <li class="active">字典评论管理</li>
    </ol>
@stop
                        ...
                        <div class="container-fluid">
                            <form class="form-inline">
                                <div class="form-group">
                                    <label for="search-name">所属汉字id</label>
                                    <input type="text" class="form-control" id="search-postid" placeholder="所属汉字id" name="search-postid">
                                </div>
                                <div class="form-group">
...
@section('js')
    <script>
        ...
        //搜索按钮事件
        function btnquery() {
            $("#table").bootstrapTable('refresh', {url: "{{route('dict.comment.lists')}}"});
