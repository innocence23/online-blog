                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form name="myForm" id="form1" novalidate>
                            ...
                            <div class="form-group">
                                <label for="carousel-pic" class="control-label">头图<em class="text-danger">（必填）</em> :</label>
                                ...
                                <input type="hidden" class="form-control" id="File" ng-model="carousel.pic" required>
                            </div>
    ...
    <script>
        $(function () {
            ...
            $('#file0').fileinput({
                ...
                scope.carousel.pic = data.response.res;
                        ...
                        case 'edit':
                            ...
                            $http.get('/admin/carousel/' + id)
                                .then(function successCallback(response) {
                                    ...
                                    $scope.picsrc = '/uploads/' +  $scope.carousel.pic;
                                    $scope.upload_image = true;
                                });
                            break;
                        default:
