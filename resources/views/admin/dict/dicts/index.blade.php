                        ...
                        <div class="container-fluid">
                            <form class="form-inline">
                                ...
                                <div class="form-group">
                                    ...
                                    <select chosen class="form-control" name="cate_id" id="cate_id" ng-model="dict.cate_id"
                                ...
                                <div class="form-group">
                                    ...
                                    <select chosen class="form-control" name="bushou_id" id="bushou_id" ng-model="dict.bushou_id"
    ...
    <script>
        ...
        $('#table').bootstrapTable({
            ...
            columns: [{
                ...
                valign: 'middle',
                formatter:  function (value, row, index) {
                    var m = '<a class="btn btn-default" href="/admin/dict/dict/'+row.id+'/edit">修改</a>';
                    var e  = value == 1 ?
